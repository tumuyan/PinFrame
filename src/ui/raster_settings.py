...
class RasterizationSettingsDialog(QDialog):
    def __init__(self, parent=None, enabled=False, grid_color=(128, 128, 128), scale_threshold=5.0, show_grid=False):
        ...
        # Show Grid Checkbox
        self.show_grid_check = QCheckBox(i18n.t("raster_show_grid"))
